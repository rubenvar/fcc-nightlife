...
var searchForm = (0, _bling.$)('form.search-location');
searchForm.on('submit', _search2.default);
...
function displayResults(e) {
  e.preventDefault();
  var resultArea = (0, _bling.$)('.results');
  resultArea.innerHTML = 'Loading...';
  _axios2.default.post(this.action, {
    location: this.location.value
  }).then(function (res) {
    var places = res.data.businesses;

    resultArea.innerHTML = '';
    (0, _bling.$)('.search-location').classList.add('hidden');
    places.forEach(function (place) {
      ...
      var image = place.image_url || '/images/pub.jpg';
