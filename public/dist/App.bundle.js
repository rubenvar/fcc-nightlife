...
function registerAssistance(e) {
  ...
  if (this.classList.contains('no-user')) {
    (0, _bling.$)('.user-forms').classList.add('visib');
    (0, _bling.$)('.login-form').classList.add('visib');
    return;
  }
  var number = this.childNodes[0].querySelector('.number');
...
exports.default = registerAssistance;
...
function ajaxLogin(e) {
  e.preventDefault();
  console.log(this);
  _axios2.default.post(this.form.action).then(function (res) {
    console.log(res);
  }).catch(console.error);
}
...
var _userForms = __webpack_require__(12);

var _login = __webpack_require__(11);

var _login2 = _interopRequireDefault(_login);

var _going = __webpack_require__(10);
